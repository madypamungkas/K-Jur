...
public class OrderWPayAdapter extends RecyclerView.Adapter<OrderWPayAdapter.CustomViewHolder>{

    List<OrderHistoryDetail> orderDetails;
    List<String> colors;

    public OrderWPayAdapter(List<OrderHistoryDetail> orderDetails) {
