...
import com.komsi.lab.kjur.ChoosePaymentActivity;
...
public class OrderCPayAdapter extends RecyclerView.Adapter<OrderCPayAdapter.CustomViewHolder>{

    List<OrderHistoryDetail> orderDetails;
    List<String> colors;

    public OrderCPayAdapter(List<OrderHistoryDetail> orderDetails) {
    ...
    public void onBindViewHolder(CustomViewHolder holder, int position) {
        ...
        holder.tvDateTime.setText(orderDetail.getDateCreate());
